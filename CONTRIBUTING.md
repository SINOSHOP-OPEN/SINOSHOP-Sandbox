...
### 1. 认领任务
在 Issue 列表中找到标记为 `状态：待认领` 的任务，在评论区输入：
/assign
...
### 2. 开始工作
- Fork 本仓库
- 创建新分支：`git checkout -b feature/issue-编号`
- 完成修改后提交：`git commit -m "描述你的改动"`

### 3. 提交 PR
- 推送到你的 Fork 仓库
- 创建 Pull Request
- PR 标题关联 Issue，如：`[docs] 更新README生态导航 (#IJRW15)`
- PR 描述中勾选完成标准

### 4. 审核与合并
- 自动化验证（如有）会自动运行
- 维护者会在48小时内审核
- 审核通过后合并，你的贡献将被记录在 CONTRIBUTORS.md
